...
const stripePromise = loadStripe(
  "pk_test_51M0tGvLfvWjhJ7QMfYrRkJY5acXGSSPjJYub52MIfIaIZSNh120WGHWqqqNXLdKQ81LnHfdygO6OaqYicMcRDTec006TrmUzNT"
);
    ...
    <Box sx={{ position: "relative", overflow: "hidden" }}>
      <HomeContainer>
        ...
        >
          ...
          >
            ...
            >
                  ...
                  >
                    ...
                    >
                      ...
                      <Stack gap={0.5}>
                        <Typography
                          variant="body2"
                          sx={{ color: "#C090FF", fontWeight: 700 }}
                        >
                          Pay only for the AWS Activate deal
                        </Typography>
                        <Typography variant="caption">
                          Pay only 149$ to get access to the AWS Activate deal
                        </Typography>
                      </Stack>
                    </Stack>
                  ...
                  >
                    ...
                    >
                      ...
                      <Stack gap={0.5}>
                        ...
                        <Typography variant="caption">
                          Get access to all our deals including AWS Activate
                          with our Unlimited subscription
                        </Typography>
                      </Stack>
                    </Stack>
                    <Typography variant="body2" sx={{ fontWeight: 800 }}>
              ...
              <Stack gap={4}>
                <Typography
                  variant="h5"
                  sx={{ fontFamily: "Heebo", fontWeight: 600 }}
                >
                  Payment Details
                </Typography>
                <Stack gap={0.5}>
            ...
            >
              ...
              <Stack gap={1} sx={{ pt: 6 }}>
                ...
                >
                  <Typography
                    variant="body2"
                    sx={{ fontWeight: 400, color: "#CAAFED" }}
                  >
                    Subtotal
                  </Typography>
                ...
                <Stack
                  ...
                  sx={{ py: 2 }}
                >
                  <Typography variant="subtitle1" sx={{ color: "#AE70FF" }}>
                    Total
                  </Typography>
          ...
          <PaymentComplete open={open} handleClose={handleClose} />
        </Box>
      </HomeContainer>
      <PricingPattern />
