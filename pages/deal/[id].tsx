                    ...
                    >
                        <Stack flex={1} gap={matchUpMd ? 10 : 6}>
                            <Breadcrumbs separator=">"  aria-label="breadcrumb">
                                ...
                                <Typography color="text.primary">{data?.deals?.[0]?.companyName ?? ''}</Typography>
                            </Breadcrumbs>
                            <Stack 
                            ...
                            >
                                <Stack flexDirection="row">
                                    <Box 
                                        component="img"
                                        // src="/images/aws.png"
                                        src={data?.deals?.[0]?.companyLogoURL ?? ''}
                                        sx={{
                                            width: 120,
                                            height: 115
                                        }}
                                ...
                                <Stack>
                                    ...
                                    >{data?.deals?.[0]?.companyName ?? ''}</Typography>
                                    <Typography 
                                        variant="h6" 
                                        sx={{ 
                                            fontWeight: 400, 
                                    ...
                                    >{data?.deals?.[0]?.descriptionInHTML ?? ''}</Typography>
                                </Stack>
                            </Stack>
                            <Typography
                                variant="h5"
                            ...
                            >{data?.deals?.[0]?.smallDesc ?? ''}</Typography>
                        </Stack>
                        <Box flex={1}
                            sx={{
                                width: '100%',
