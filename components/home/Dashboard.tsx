            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <BoxCard top={0} right={100} move={move3} bottom={undefined} left={undefined} title={''} content={''} />
                            <BoxCard left={-100} bottom={100} move={move2} top={undefined} right={undefined} title={''} content={''} />
                            <BoxCard right={0} bottom={0} move={move4} top={undefined} left={undefined} title={''} content={''} />
                            <Box    
                                component="img" 
                                src="/images/box1.png" 
                                sx={{
                    ...
                    >
                        <BoxCard top={0} right={100} move={move3} bottom={undefined} left={undefined} title={''} content={''} />
                        <BoxCard left={-100} bottom={100} move={move2} top={undefined} right={undefined} title={''} content={''} />
                        <BoxCard right={0} bottom={0} move={move5} top={undefined} left={undefined} title={''} content={''} />
                        <Stack flexDirection="row">
                            <Box 
                                component="img" 
                                src="/images/box1.png" 
